...
public class VolumeScreen {
    ...
    @FindBy(xpath = "//android.widget.TextView[@content-desc='9000000']")
    public WebElement cubic_cm_result;
    
    AndroidDriver driver;

    public VolumeScreen(AndroidDriver driver) {
        this.driver = driver;
        PageFactory.initElements(new AppiumFieldDecorator(driver), this);
    }
    public boolean CubicMeter_to_CubicCentimeter(){
        Number9.click();
        return cubic_cm_result.isDisplayed();
    }
