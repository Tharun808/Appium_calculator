...
public class MassScreen {
    ...
    @FindBy(xpath = "//android.widget.TextView[@content-desc='31000']")
    public WebElement gram_result;
    
    AndroidDriver driver;

    public MassScreen(AndroidDriver driver) {
        this.driver = driver;
        PageFactory.initElements(new AppiumFieldDecorator(driver), this);
    }
    public boolean Kilo_to_Gram(){
        Number3.click();
        Number1.click();
        return gram_result.isDisplayed();
    }
