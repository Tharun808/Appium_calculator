...
public class AreaScreen {
    ...
    @FindBy(xpath = "//android.widget.TextView[@content-desc='1000000']")
    public WebElement sqr_cm_result;

    AndroidDriver driver;

    public AreaScreen(AndroidDriver driver) {
        this.driver = driver;
        PageFactory.initElements(new AppiumFieldDecorator(driver), this);
    }
    public boolean Sqm_sqcm(){
        Number1.click();
        Number00.click();
        return sqr_cm_result.isDisplayed();
    }
